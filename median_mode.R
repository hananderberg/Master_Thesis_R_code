...
dat.complete.norm <- impute(dat.norm.mis, method = "median/mode")

## Here are the final results
summary(dat.complete.norm)
...
rmse_num_mm <- sqrt(mean_squared_diff_num)
rmse_num_mm
...
rmse_cat_mm <- sqrt(mean_squared_diff_cat)
rmse_cat_mm
...
rmse_full_mm <- sqrt(mean_squared_diff)
rmse_full_mm

cat("Mean/median: "," RMSE numerical: ",rmse_num_mm, " RMSE categorical: ", rmse_cat_mm, " RMSE: ", rmse_full_mm)
